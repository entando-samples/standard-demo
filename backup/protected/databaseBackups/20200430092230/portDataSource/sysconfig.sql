...
<reports status="OK">
	<creation>2020-03-20 16:26:21</creation>
	<lastupdate>2020-03-20 16:26:21</lastupdate>
	<components>
		<component code="entandoCore" date="2020-03-20 16:26:21" status="OK">
			<schema status="OK">
		...
		<component code="jacms" date="2020-03-20 16:26:21" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="OK">
		...
		<component code="jprestapi" date="2020-03-20 16:26:21" status="OK">
			<schema status="OK">
		...
		<component code="entando-admin-console" date="2020-03-20 16:26:21" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="OK">
		...
		<component code="entando-portal-ui" date="2020-03-20 16:26:21" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
		...
		<component code="jpkiebpm" date="2020-03-20 16:26:21" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="OK">
		...
		<component code="entando-app-view-cms-default" date="2020-03-20 16:26:21" status="OK">
			<schema status="OK">
				<datasource name="portDataSource" status="NOT_AVAILABLE" />
				<datasource name="servDataSource" status="NOT_AVAILABLE" />
			</schema>
...
');
INSERT INTO sysconfig (version,item,descr,config) VALUES ('production','subIndexDir','Name of the sub-directory containing content indexing files','indexdir20200402084304');
...
<contenttypes>
	...
	<contenttype typecode="COM" typedescr="COMPOSITE" viewpage="**NULL**" listmodel="**NULL**" defaultmodel="**NULL**">
		<attributes>
			<list name="IMG" attributetype="Monolist" description="IMAGE_MONOLIST">
				<validations>
					<required>true</required>
				</validations>
				<nestedtype>
					<attribute name="IMG" attributetype="Image" />
				</nestedtype>
			</list>
			<attribute name="TEX" attributetype="Text" description="TEXT" searchable="true" indexingtype="TEXT">
				<validations>
					<required>true</required>
				</validations>
			</attribute>
			<list name="MOL" attributetype="Monolist" description="MONOLIST">
				<validations>
					<required>true</required>
				</validations>
				<nestedtype>
					<attribute name="MOL" attributetype="Attach" />
				</nestedtype>
			</list>
			<attribute name="DAT" attributetype="Date" description="DATE" searchable="true" indexingtype="TEXT">
				<validations>
					<required>true</required>
				</validations>
			</attribute>
	...
	<contenttype typecode="IMG" typedescr="IMAGE" viewpage="**NULL**" listmodel="**NULL**" defaultmodel="**NULL**">
		<attributes>
			<attribute name="IMM" attributetype="Image" description="IMAGE" indexingtype="TEXT">
				<validations>
					<required>true</required>
				</validations>
			</attribute>
	...
	<contenttype typecode="IML" typedescr="IMAGE_LIST" viewpage="**NULL**" listmodel="**NULL**" defaultmodel="**NULL**">
		<attributes>
			<list name="IML" attributetype="List" description="IMAGE_LIST">
				<nestedtype>
					<attribute name="IML" attributetype="Image" />
				</nestedtype>
			</list>
		</attributes>
	</contenttype>
	<contenttype typecode="IMM" typedescr="IMAGE_MONOLIST" viewpage="**NULL**" listmodel="**NULL**" defaultmodel="**NULL**">
		<attributes>
			<list name="IMG" attributetype="Monolist" description="IMAGE_MONOLIST">
				<validations>
					<required>true</required>
	...
	<contenttype typecode="LIN" typedescr="LINK" viewpage="**NULL**" listmodel="**NULL**" defaultmodel="**NULL**">
		<attributes>
			<attribute name="LINK" attributetype="Link" description="LINK" indexingtype="TEXT">
				<validations>
					<required>true</required>
				</validations>
			</attribute>
