...
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('keycloak',NULL,NULL,'<script src="http://quickshift-kc-sales-demo.lab.entando.org/auth/js/keycloak.js"></script>
<script>
...
<div class="btn-group login-group">
    ...
    <a class="manage-users" href="<@wp.url page="manage_users" />" >
...
<manageusers-table  pagination-mode="pagination" service-url="http://quickshift-sales-demo.lab.entando.org" keycloak-url="http://quickshift-kc-sales-demo.lab.entando.org" realm="entando"/>',NULL,0);
