...
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('main_banner','main_banner',NULL,' <div class="main-banner">
            <div class="row">
                <div class="col-lg-6 col-xs-12">
                    <div class="text-wrapper">
                        <h1>A Better Way to Bank</h1>
                        <p>Seed is looking to change how people bank by eliminating fees, and using technology to provide you with tools that help you take charge of your finances.</p>
                    </div>
                </div>
            </div>
        </div>',NULL,0);
...
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('login_buttons','login_buttons',NULL,'<button class="btn sign-up">Sign Up</button>
<button class="btn login">Login</button>',NULL,0);
