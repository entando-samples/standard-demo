...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/seedscardtransaction/tableWidget/>):
   1. Run `npm i`
...
- **seedscardtransaction.table.error** (fired when an error occurs)
- **seedscardtransaction.table.select** (fired when a table row is selected)
