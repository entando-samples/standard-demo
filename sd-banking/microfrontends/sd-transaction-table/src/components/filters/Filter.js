    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="date">{t('entities.seedscardtransaction.date')}</option>
            <option value="description">{t('entities.seedscardtransaction.description')}</option>
            <option value="amount">{t('entities.seedscardtransaction.amount')}</option>
            <option value="balance">{t('entities.seedscardtransaction.balance')}</option>
            <option value="accountID">{t('entities.seedscardtransaction.accountID')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
