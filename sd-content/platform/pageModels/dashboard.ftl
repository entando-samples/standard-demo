        ...
        <div class="dashboard-container">
            ...
            <div class="row">
                <div class="NotificationBar">
                    ...
                    <div class="NotificationBar__btn"><img class="CheckingCard__icon" src="<@wp.resourceURL />bundles/sd-content-bundle-20d9c12f/resources/static/img/dashboard/Framepay.png"/>
                        Pay bills
                    </div>
                    <div class="NotificationBar__btn"><img class="CheckingCard__icon" src="<@wp.resourceURL />bundles/sd-content-bundle-20d9c12f/resources/static/img/dashboard/Framemoney.png"/>
                        Send money
                    </div>
                    <div class="NotificationBar__btn"><img class="CheckingCard__icon" src="<@wp.resourceURL />bundles/sd-content-bundle-20d9c12f/resources/static/img/dashboard/Frameinvest.png"/>
                        Investments
                    </div>
                    <div class="NotificationBar__btn"> <@wp.show frame=11 /> </div>
                    <div class="NotificationBar__btn">  <img class="CheckingCard__icon" src="<@wp.resourceURL />bundles/sd-content-bundle-20d9c12f/resources/static/img/dashboard/Frametransfer.png"/>
                        Transfers
                    </div>
                </div>
            </div>
